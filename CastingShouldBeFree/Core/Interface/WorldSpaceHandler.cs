...
public class WorldSpaceHandler : Singleton<WorldSpaceHandler>
{
    ...
    {
        RenderTexture renderTexture = Instantiate(Plugin.Instance.CastingBundle.LoadAsset<RenderTexture>("CameraRenderTexture"));
        ...
        RenderTextureCamera.forceIntoRenderTexture = true;
    ...
    private void Update()
    {
        ...
        bool isPressed = ControllerInputPoller.instance.leftControllerPrimaryButton || UnityInput.Current.GetKey(KeyCode.F);
