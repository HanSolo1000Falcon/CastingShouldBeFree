    ...
    private void LateUpdate()
    {
        ...
        if (CameraHandler.Instance.SmoothingFactor > 0)
        {
            ...
            if (SnappySmoothing)
            {
                ...
                otherTargetPos = Vector3.Lerp(CameraHandler.Instance.transform.position, targetPosition, Time.deltaTime * realSmoothingFactor * velocity.magnitude);
            ...
            {
                otherTargetPos = Vector3.Lerp(CameraHandler.Instance.transform.position, targetPosition, Time.deltaTime * realSmoothingFactor);
                otherTargetRot = Quaternion.Slerp(CameraHandler.Instance.transform.rotation, targetRotation, Time.deltaTime * realSmoothingFactor);
            }
        }
